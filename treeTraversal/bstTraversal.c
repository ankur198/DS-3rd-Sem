...
void getChildsInorder(struct node *pointer)
{
	if (pointer->left != NULL)
	{
		getChildsInorder(pointer->left);
	}
	printf("%d  ",pointer->data);
	if (pointer->right != NULL)
	{
		getChildsInorder(pointer->right);
	}
}

void getChildsPreorder(struct node *pointer)
{
	printf("%d  ", pointer->data);
	if (pointer->left != NULL)
	{
		getChildsPreorder(pointer->left);
	}
	if (pointer->right != NULL)
	{
		getChildsPreorder(pointer->right);
	}
}

void getChildsPostorder(struct node *pointer)
{
	if (pointer->left != NULL)
	{
		getChildsPostorder(pointer->left);
	}
	if (pointer->right != NULL)
	{
		getChildsPostorder(pointer->right);
	}
	printf("%d  ", pointer->data);
}
...
{
	printf("\n\n\nInorder: ");
	getChildsInorder(root);

	printf("\n\n\nPreorder: ");
	getChildsPreorder(root);

	printf("\n\n\nPostorder: ");
	getChildsPostorder(root);
